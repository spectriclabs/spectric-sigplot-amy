    ...
    if (!ArrayBuffer.transfer) {
        ArrayBuffer.transfer = function (source, length) {
            if (!(source instanceof ArrayBuffer)) {
                throw new TypeError(
                    "Source must be an instance of ArrayBuffer"
                );
            }
        ...
        (function () {
            function l() {
                ...
                var g = function (a, b) {
                    ...
                    var e = b;
                    b = { get: null, set: null, apply: null, construct: null };
                    for (var k in e) {
                        if (!(k in b)) {
                            throw new TypeError(
                                "Proxy polyfill does not support trap '" +
                                    k +
                                    "'"
                            );
                        }
                    ...
                    "function" === typeof a
                        ? ((c = function () {
                              ...
                              f(h ? "construct" : "apply");
                              return h && b.construct
                                  ? b.construct.call(this, a, d)
                                  : !h && b.apply
                                  ? b.apply(a, this, d)
                                  : h
                    ...
                    Object.getOwnPropertyNames(a).forEach(function (b) {
                        if (!((g || q) && b in c)) {
                            var d = {
                                enumerable: !!Object.getOwnPropertyDescriptor(
                                    a,
                                    b
                                ).enumerable,
                                get: r.bind(a, b),
                    ...
                    Object.setPrototypeOf
                        ? Object.setPrototypeOf(c, Object.getPrototypeOf(a))
                        : c.__proto__
            ...
            var u =
                ...
                ("undefined" !== typeof navigator &&
                    ...
                    : self;
            u.Proxy ||
                ((u.Proxy = l()), (u.Proxy.revocable = u.Proxy.revocable));
        })();
        /* jshint ignore:end */
    }
